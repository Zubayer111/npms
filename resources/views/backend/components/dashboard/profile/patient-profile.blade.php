            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#treatments" data-toggle="tab">Prescritions</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="treatments">
                    ...
                    <div class="timeline timeline-inverse">
                      <section class="content">
                        <div class="card card-info">
                            @include("backend.components.dashboard.profile.tab-content.patient.prescritions")
                        </div>
                        </section>
                    </div>
