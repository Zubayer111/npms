<div class="content-wrapper">
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Active Medicine Type List Tables</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Active Medicine Type List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12 ">
            <div class="card ">
              <div class="card-header">
                <h3 class="card-title">Active Medicine Type List</h3>
  ...
  <script>
    ...
    function confirmInactive(id) {
          Swal.fire({
              title: 'Deactivate Medicine Type!',
...
<script type="text/javascript">
  $(document).ready(function() {
      $('#type_table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('dashboard.active-medicine-type-list') }}",
